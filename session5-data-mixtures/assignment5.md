...
```mermaid
graph TD
    ST1["STAGE 1: Base Knowledge and Grammar Acquisition<br/>2.0 Trillion Tokens - Context: 4,096"] --> ST2
    ST2["STAGE 2: Structured Logic and Multilingual Scaling<br/>1.2 Trillion Tokens - Context: 8,192"] --> ST3
    ST3["STAGE 3: Complex Multi-Step Reasoning and Synthetic CoT<br/>0.8 Trillion Tokens - Context: 16,384"] --> ST4a
